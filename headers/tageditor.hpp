 ...
 */
void editTags(std::vector<std::string> songNames, std::string songsDirPath,  std::vector<MetadataSearcher::MP3Tag>* metadatas, std::string artistName, bool noImage = false);
 ...
 * @param artistName artist name string
 */
void editTag(std::string songName, MetadataSearcher::MP3Tag* metadatas, std::string artistName, bool noImage);
