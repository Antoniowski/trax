 ...
 */
void editTags(std::vector<std::string> songNames, std::string songsDirPath,  std::vector<MetadataSearcher::MP3Tag>* metadatas, std::string artistName, std::string genres, bool noImage = false, bool complexName = false);
 ...
 * @param artistName artist name string
 */
void editTag(std::string songName, MetadataSearcher::MP3Tag* metadatas, std::string artistName, std::string genres, bool noImage, bool complexName = false);
